            ...
            <div className="rounded-[2.4rem] border border-[var(--border)] bg-[image:var(--tyash-surface-gradient)] p-7 shadow-[0_22px_54px_rgba(221,204,176,0.14)] sm:p-8">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <h2 className="mt-5 whitespace-nowrap font-[family:var(--font-cormorant)] text-[2.4rem] leading-[0.95] tracking-[-0.04em] text-[var(--heading-color)] sm:text-[3rem]">
                    Ton accès est prêt
                  </h2>
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-col gap-4">
                <Link
                  href="/mon-espace"
                  className="flex h-15 w-full items-center justify-center rounded-[1.15rem] bs-button-primary px-6 text-sm font-extrabold uppercase tracking-[0.12em] text-white shadow-[0_18px_30px_rgb(var(--tyash-glow-rgb)/0.24)] transition duration-200 hover:-translate-y-0.5"
                >
                  Ouvrir ma formation
                </Link>
                <Link
                  href="/"
                  className="flex h-15 w-full items-center justify-center rounded-[1.15rem] border border-[var(--border)] bg-[var(--card)] px-6 text-sm font-extrabold uppercase tracking-[0.12em] text-[var(--text-muted)] transition duration-200 hover:-translate-y-0.5"
                >
