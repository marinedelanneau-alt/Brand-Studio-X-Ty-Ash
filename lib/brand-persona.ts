    ...
    sections: [
      {
        ...
        questions: [
          ...
          createQuestion("identity", 2, {
            ...
            helperText: "L'âge peut être réel ou symbolique.",
          ...
          createQuestion("identity", 3, {
            ...
            helperText: "Un rôle qui exprime ce que ta marque apporte au monde.",
          ...
          createQuestion("identity", 4, {
            ...
            label: "Phrase qui résume cette personne",
            helperText: "Une phrase simple pour saisir son essence immediatement.",
            placeholder: "Ex. Une présence claire qui aide à avancer avec confiance.",
            fieldType: "textarea",
            example: "",
            required: true,
          }),
      ...
      },
      {
        ...
        description:
          "Définis sa façon d'être, d'entrer en relation et de faire passer ses idées.",
        order: 2,
        isActive: true,
        questions: [
          createQuestion("personality", 1, {
            ...
            placeholder: "Ex. Claire, structurée, rassurante",
            fieldType: "text",
            example: "Claire, structurée, rassurante",
            required: true,
          }),
          ...
          createQuestion("personality", 3, {
            ...
            placeholder: "Ex. Accessible sans être familier, expert sans être froid",
            fieldType: "textarea",
            example: "Accessible sans être familier, expert sans être froid",
            required: true,
          }),
      ...
      },
      {
        ...
        description:
          "Traduis sa personnalité en signaux visuels concrets pour inspirer ton univers de marque.",
        order: 3,
        isActive: true,
        questions: [
          ...
          createQuestion("style", 2, {
            ...
            helperText: "Des couleurs qui donnent déjà le ton sans parler.",
          ...
          createQuestion("style", 3, {
            ...
            label: "Accessoires ou détails distinctifs",
          ...
          createQuestion("style", 4, {
            id: "visual_mood",
            label: "Ambiance visuelle associée",
            helperText: "Atmosphère, textures, matières, lumière.",
      ...
      },
      {
        ...
        questions: [
          ...
          createQuestion("values", 2, {
            ...
            placeholder: "Ex. La clarté, l'exigence utile et le respect du temps des gens",
            fieldType: "textarea",
            example: "",
          }),
          createQuestion("values", 3, {
            ...
            helperText: "Ce qui va à l'encontre de sa posture.",
          ...
          createQuestion("values", 4, {
            ...
            placeholder: "Ex. Sa clarté, sa constance et la qualité de ses choix",
            fieldType: "textarea",
            example: "",
          }),
        ],
      },
      {
        ...
        description:
          "Visualise la qualité de relation qu'elle installe avec son audience.",
        order: 5,
        isActive: true,
        questions: [
          createQuestion("relationships", 1, {
            ...
            placeholder: "Ex. Avec chaleur, clarté et une vraie sensation d'être attendu",
            fieldType: "textarea",
            example: "",
          }),
          ...
          createQuestion("relationships", 3, {
            ...
            helperText: "Décris le rôle qu'elle joue pour les autres.",
            placeholder: "Ex. Une amie lucide qui dit les choses avec tact et aide à trancher",
            fieldType: "textarea",
            example: "",
          }),
      ...
      },
      {
        ...
        questions: [
          ...
          createQuestion("environment", 2, {
            ...
            placeholder: "Ex. Carnet crème, stylo lourd, bouquet sobre, échantillons matières",
            fieldType: "textarea",
            example: "",
          }),
      ...
      },
      {
        ...
        description:
          "Condense ce persona pour qu'il devienne un repère concret à chaque prise de parole.",
        order: 7,
        isActive: true,
        questions: [
          createQuestion("summary", 1, {
            ...
            helperText: "Ta phrase-repère finale.",
            placeholder: "Ex. Une guide claire, élégante et rassurante qui aide à mieux choisir.",
            fieldType: "textarea",
            example: "",
            required: true,
          }),
          createQuestion("summary", 2, {
            ...
            placeholder: "Ex. Avec clarté, tact et une vraie intention d'aider",
            fieldType: "textarea",
            example: "",
          }),
        ],
